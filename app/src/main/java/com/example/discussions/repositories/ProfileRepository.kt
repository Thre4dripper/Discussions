...
class ProfileRepository {
    companion object {
        ...
        fun getUsernameAndImage(context: Context, callback: ResponseCallback) {
            val token = LoginStore.getJWTToken(context)!!
            NameImageApi.getUsernameAndImageJson(context, token, object : ResponseCallback {
                override fun onSuccess(response: String) {
                    map = NameImageApi.parseUsernameAndImageJson(response)
                    callback.onSuccess("Success")
                }
